...
{-|
Module      : Frames.Polymorphic.MapReduce
Description : Polymorphic (in Record type and interpretation functor) Helpers for using the map-reduce-folds package with Frames
